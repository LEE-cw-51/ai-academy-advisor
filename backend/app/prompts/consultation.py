...
톤의 정본은 아래 few-shot과 `consultation_service`의 fallback 문장이다. 2026-09-14
`/check`·`/checklists` 퇴역 전 두 페이지의 문구를 그대로 옮겨 왔다 — 새 말투를 만들지 않는다.
"""

from __future__ import annotations

# 재원 점검 상담 문항 (옛 /check counseling: fit/needs_work, feedback/sometimes, climate/sometimes)
FEW_SHOT_CHECK = (
...
# 등록 전 상담 질문 (옛 /checklists before-enroll)
FEW_SHOT_CHECKLIST = (
...
- 질문은 학부모가 상담 때 소리 내 읽을 한 문장이다. 아래 좋은 질문 예와 같은 말투(…나요?).
