...
학원콕은 하남 미사 학부모가 학원과 아이의 학습 상태를 둘러싼 **블랙박스를 줄이고, 더 나은 질문과 판단을 하도록 돕는 무료 AI 보조 학원 탐색 서비스**입니다. 사용자의 상황과 고민을 탐색 조건·상담 질문·추가 확인 항목으로 정리하고, 출처와 확인일이 있는 학원 기본 정보를 보여줍니다. 수강 신청·예약·결제·상담 대행·리드 전달은 첫 MVP 범위에 포함하지 않습니다.
